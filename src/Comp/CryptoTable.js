...
import icon3 from "./Images/gr3.png";
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="flex justify-between items-center py-4 overflow-x-auto">
        ...
        <div className="flex items-center space-x-4 ml-4 button-group ">
        ...
        <div className="flex space-x-4 items-center md:mx-5">
          <span className="text-gray-500 text-sm ml-8 sm:ml-0 ">Show rows</span>
          <select
            value={rowsToShow}
            onChange={handleRowsToShowChange}
            className="text-gray-500 text-sm border rounded-full px-3 py-2 ml-4 sm:ml-0"
          >
      ...
      <div className="flex flex-col items-center py-4">
        <div className="flex flex-col md:flex-row justify-between items-center w-full space-y-2 md:space-y-0">
          ...
          <div className="flex items-center mt-2 md:mt-0">
            <span className="text-gray-500 text-sm mr-2">Show rows</span>
            <select
              value={rowsToShow}
              onChange={handleRowsToShowChange}
